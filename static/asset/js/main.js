(function ($) {
    ...
    this.leftMenu =  function()
    {
         ...
         $('.opener-left-menu').on('click', function(){
            ...
            if( $('#left-menu .sub-left-menu').is(':visible') ) {
                ...
                $('#left-menu .sub-left-menu').animate({ 'width': '230px' }, 'fast');
                $('#content').animate({ 'padding-left': '230px','padding-right':'0px'}, 'fast');
                $('.overlay').hide();
    ...
    this.rightMenu =  function(){
            ...
            if($('#right-menu').is(':visible') ) {
                ...
                $('#right-menu').show();
                $('#right-menu').animate({ 'width': '230px' }, 'fast');
                $('#content').animate({ 'padding-right': '230px'}, 'fast');
            }
        });
    };
